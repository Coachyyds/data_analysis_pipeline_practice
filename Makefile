...
# All target - runs the complete pipeline
all: report/count_report.html

# Word count targets - generate .dat files from text files
...
# Plot targets - generate .png files from .dat files
...
# Report target - generate HTML report from all figures
